...
int64 nChainStartTime = 1477726632;
...
const string strMessageMagic = "Cross-Stratum Coin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if(nHeight >= 1 && nHeight <= 84)
    {
        nSubsidy = 1000000 * COIN;
    }

    else if(nHeight > 84 && nHeight <= 9000000)
    {
        nSubsidy = 0.0 * COIN;
    }
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in cscoincoin
    bool fStrictPayToScriptHash = true; // Always active in cscoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "cscoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CBlock CSyncCheckpoint cscoin empty mapOrphanBlocks cscoin cscoin";
        CTransaction txNew;
        ...
        block.nNonce   = 62068;
        //block.nNonce   = !fTestNet ? 91197 : 91197;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        assert(block.hashMerkleRoot == uint256("0xeac470da56c2a4e63c03dee7b50c7792e8d3e091910b6f43092a0a9308c12e62"));
