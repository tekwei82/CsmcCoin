...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "cscoin - Debug window", 0, QApplication::UnicodeUTF8));
        ...
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the cscoin-Qt help message to get a list with possible cscoin command-line options.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        ...
        label_9->setText(QApplication::translate("RPCConsole", "cscoin Core", 0, QApplication::UnicodeUTF8));
        label_4->setText(QApplication::translate("RPCConsole", "Estimated total blocks", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the cscoin debug log file from the current data directory. This can take a few seconds for large log files.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
